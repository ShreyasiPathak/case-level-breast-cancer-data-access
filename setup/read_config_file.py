...
def read_config_file(config_file):
    ...
    if config_params['femodel']=='gmic_resnet18':
        config_params['gmic_parameters'] = {
            #"device_type": str(config_params['device']),
        ...
        if str(config_params['device'])=='cpu':
            config_params['gmic_parameters']["gpu_number"] = None
            config_params['gmic_parameters']["device_type"] = 'cpu'
        else:
            config_params['gmic_parameters']["gpu_number"] = str(config_params['device'])
            config_params['gmic_parameters']["device_type"] = 'gpu'
