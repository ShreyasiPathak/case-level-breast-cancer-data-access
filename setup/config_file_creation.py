...
import os
from hyperparameter_optim import generate_hyperparameter_configurations
...
#ResNet34 final hyperparameter config
...
for hyperparam in hyperparam_config[start:end]:
    ...
    config_object["parametersetting"] = {
            ...
            "usevalidation": True,
            "batchsize": 1, #options=10, 20
            "numclasses": 1,
            "maxepochs": 2, #150
            "numworkers": 0,
            "lr": float(hyperparam['lr']), #float(hyperparam['lr']), #10**float(hyperparam['lr']), #0.001, 0.00002
            "wtdecay": float(hyperparam['wtdecay']), #float(hyperparam['wtdecay']), #10**float(hyperparam['wtdecay']), #0.0005, 0.00001
            "sm_reg_param": float(hyperparam['sm_reg_param']), #float(hyperparam['sm_reg_param']), #float(hyperparam['sm_reg_param']), #float(hyperparam['sm_reg_param']), #float(hyperparam['sm_reg_param']), #10**float(hyperparam['sm_reg_param']), False
            ...
            "resize": [224, 224], #options=1600, zgt, cbis-ddsm: [2944,1920], vindr:[2700, 990], None (for padding to max image size )
            "cam_size": (7, 7), #(92, 60), #(48, 24), #vindr: (85, 31), zgt:(92, 60)
            "crop_shape": (32, 32), #(256, 256), #(130, 130), #(256, 256)
            ...
            "ROIpatches": 6, #6, #options: any number, 6 from gmic paper
            ...
            "extra": False #'descendorder' #options: dynamic_training, dynamic_training_async
    }
    count+=1
    filename=''
    ...
    if config_object["parametersetting"]['dataset'] == 'cbis-ddsm':
        ...
        #path_to_output = "/home/pathaks/PhD/case-level-breast-cancer/multiview_mammogram/models_results/cbis-ddsm/paper2/" + filename + '/'
...
IKIM
cbis-ddsm: 
'/projects/dso_mammovit/project_kushal/data/cbis-ddsm_singleinstance_groundtruth.csv'
'/projects/dso_mammovit/project_kushal/data/cbis-ddsm_multiinstance_groundtruth.csv'
'/projects/dso_mammovit/project_kushal/data/multiinstance_data_16bit'
"/projects/dso_mammovit/project_kushal/data/multiinstance_data_8bit"

zgt:
"/homes/spathak/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_final4_viewsextended_SI.csv", 
"/homes/spathak/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_final4_viewsextended.csv"
"/homes/spathak/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_biradscombined_breastdensityadded_patientinfoadded_final4.csv"
"/groups/dso/spathak"

vindr:
"/groups/dso/spathak/vindr/MG_training_files_vindr_singleinstance_groundtruth.csv"
"/groups/dso/spathak/vindr/MG_training_files_vindr_multiinstance_groundtruth.csv"
...
ut machine:
cbis-ddsm:
"/deepstore/datasets/dmb/medical/breastcancer/mammography/cbis-ddsm/cbis-ddsm_singleinstance_groundtruth.csv"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/cbis-ddsm/multiinstance_data_8bit"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/cbis-ddsm/multiinstance_data_16bit"

zgt: 
"/home/pathaks/PhD/case-level-breast-cancer/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_final4_viewsextended_SI.csv"
"/home/pathaks/PhD/case-level-breast-cancer/multiview_mammogram/input_data/MG_training_files_studyUID_accessionNum_viewnames_final4_viewsextended.csv"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/zgt"  

vindr:
"/deepstore/datasets/dmb/medical/breastcancer/mammography/vindr/MG_training_files_vindr_singleinstance_groundtruth.csv"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/vindr/MG_training_files_vindr_multiinstance_groundtruth.csv"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/vindr/processed_png_8bit"
"/deepstore/datasets/dmb/medical/breastcancer/mammography/vindr/processed_png_16bit"

cmmd:
'/deepstore/datasets/dmb/medical/breastcancer/mammography/cmmd/cmmd_singleinstance_groundtruth.csv'
'/deepstore/datasets/dmb/medical/breastcancer/mammography/cmmd/processed_png_8bit'
