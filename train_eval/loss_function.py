...
from utilities.utils import class_distribution_poswt, class_distribution_weightedloss

def class_imbalance(config_params, df):
    if config_params['classimbalance'] == 'poswt':
        class_weights = class_distribution_poswt(df).to(config_params['device'])
    elif config_params['classimbalance'] == 'wtcostfunc':
        class_weights = class_distribution_weightedloss(config_params, df).to(config_params['device'])
    else:
        class_weights = None
