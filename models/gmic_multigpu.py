...
from utilities.data_augmentation_utils import ROIRotateTransform 
from utilities.gmic_utils import crop_pytorch
import models.gmic_modules_multigpu as m
...
class GMIC(nn.Module):
    def __init__(self, parameters):
        ...
        # detection network
        #self.roitransform = ROIRotateTransform([0, 90, 180, 270])
