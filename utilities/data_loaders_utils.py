...
#from utilities.utils import stratified_class_count #circular import error was coming from this line. So, I had to replace this line with import utilities.utils. That solved the problem.
from utilities.data_augmentation_utils import MyPaddingLongerSide, MyHorizontalFlip
from utilities.gmic_utils import load_image, gmic_image_cleaning
import mlflow
...
class CustomWeightedRandomSampler(Sampler):
    ...
    def __iter__(self):
        ...
        class_count = utilities.utils.stratified_class_count(self.df)
