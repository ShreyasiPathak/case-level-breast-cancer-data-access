...
from train_eval.loss_function import loss_fn_gmic_initialize, loss_fn_gmic, loss_fn_bce, loss_fn_crossentropy
    ...
    with torch.no_grad():
        for test_idx, test_batch, test_labels, views_names in dataloader_test:
            ...
            if config_params['femodel'] == 'gmic_resnet18':
                ...
                loss1 = loss_fn_gmic(config_params, bcelogitloss, bceloss, output_batch_local, output_batch_global, output_batch_fusion, saliency_map, test_labels, None,  output_patch, test_bool=True).item()
